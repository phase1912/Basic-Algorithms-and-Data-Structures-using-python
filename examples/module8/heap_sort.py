...
def heap_sort_in_one_method(iterable, descending=False):
...
sorted_arr_asc = heap_sort_in_one_method(arr)
print("Відсортований масив (за зростанням):", sorted_arr_asc)
# Сортування за спаданням
sorted_arr_desc = heap_sort_in_one_method(arr, descending=True)
print("Відсортований масив (за спаданням):", sorted_arr_desc)